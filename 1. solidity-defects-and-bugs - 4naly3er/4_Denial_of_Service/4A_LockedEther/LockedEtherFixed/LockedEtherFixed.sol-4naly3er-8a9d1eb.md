...
| [GAS-1](#GAS-1) | Use Custom Errors instead of Revert Strings to save Gas | 3 |
...
9:         require(msg.value == amount, "Incorrect amount");

16:         require(_balance[msg.sender] != 0, "No balance found");

19:         require(sent, "Failed to send Ether");
