...
*Instances (1)*:
```solidity
File: DoSWithGasLimit.sol

30:     function distributeToBenefactors() external onlyOwner {
...
32:         uint256 ammountPerBenefactor = address(this).balance / benefactorsCount;
...
34:             bool success = _benefactors[index].send(ammountPerBenefactor);
...
26:         benefactorsCount = benefactorsCount + 1;

32:         uint256 ammountPerBenefactor = address(this).balance / benefactorsCount;

33:         for (uint256 index = 1; index <= benefactorsCount; index++) {
...
25:     function registerBenefactor(address payable benefactor) external {
