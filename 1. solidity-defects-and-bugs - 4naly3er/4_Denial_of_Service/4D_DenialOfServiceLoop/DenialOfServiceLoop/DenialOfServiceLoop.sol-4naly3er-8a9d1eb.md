...
36:             benefactors[index].transfer(ammountPerBenefactor);
...
9:     mapping(address => bool) private rewardCollected;
...
8:     mapping(uint256 => address payable) private benefactors;
