...
*Instances (1)*:
```solidity
File: PossibleDivisionByZeroArrayLengthFixed.sol
...
7:         require(recipients.length > 1, "Please provide 2 or more recipients");
...
6:     function split(address[] calldata recipients) external payable {
