...
*Instances (1)*:
```solidity
File: Unexpected_Throw_Or_Revert.sol
...
16:             revert("The big was lower than the current highest bid");
...
10:     function bid() external payable {
...
12:             require(payable(_highestBidder).send(_highestBid));
