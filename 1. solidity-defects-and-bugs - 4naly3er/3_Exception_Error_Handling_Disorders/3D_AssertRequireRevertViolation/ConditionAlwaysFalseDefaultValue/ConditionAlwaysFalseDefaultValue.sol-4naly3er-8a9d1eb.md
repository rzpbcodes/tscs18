...
*Instances (1)*:
```solidity
File: ConditionAlwaysFalseDefaultValue.sol
...
18:         require(_limit < _currentCount, "The limit has been reached");
...
11:     mapping(uint256 => address) private _participants;
