...
*Instances (1)*:
```solidity
File: ConditionAlwaysFalseDefaultValueFixed.sol
...
15:         require(_limit > _currentCount, "The limit has been reached");
...
8:     mapping(uint256 => address) private _participants;
