...
*Instances (1)*:
```solidity
File: DeprecatedFunctionsFixed.sol
...
10:         deadlineTimestamp = _deadlineTimestamp;
...
13:     function receiveApplication() external {
...
6:     mapping(address => uint256) private _applicants;
