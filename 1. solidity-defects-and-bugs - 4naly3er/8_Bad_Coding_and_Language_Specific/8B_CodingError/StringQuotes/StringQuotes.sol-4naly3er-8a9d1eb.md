...
| [NC-2](#NC-2) | Strings should use double quotes rather than single quotes | 1 |
...
*Instances (1)*:
```solidity
File: StringQuotes.sol

11:         return string(abi.encodePacked('Hello', ' ', name, '!'));
...
### <a name="NC-2"></a>[NC-2] Strings should use double quotes rather than single quotes
