...
| [NC-2](#NC-2) | Default Visibility for constants | 1 |
...
*Instances (1)*:
```solidity
File: ShadowingStateParameterFixed.sol
...
6:     uint256 constant interest = 2;

```

### <a name="NC-2"></a>[NC-2] Default Visibility for constants
...
18:     function payDebt() external payable {
