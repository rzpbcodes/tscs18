...
| [NC-2](#NC-2) | Control structures do not follow the Solidity Style Guide | 1 |
...
*Instances (1)*:
```solidity
File: BlockVariableDependency.sol

36:     function chooseWinner() external onlyOwner {
...
40:         payable(_contenders[winnerIndex]).transfer(

43:         payable(owner).transfer(1 ether);
...
33:         _contendersCount = _contendersCount + 1;

41:             address(this).balance - 1 ether
...
37:         require(_contendersCount > 10, "Not enough contenders registered");
...
29:             msg.value >= 1 ether && msg.value < 2 ether,
...
38:         uint256 winnerIndex = block.difficulty % _contendersCount;
...
27:     function register(address contender) external payable {
